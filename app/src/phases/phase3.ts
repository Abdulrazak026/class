...
:::`,
        quiz: [
          ...
          { question: 'The HTTP challenge for domain validation requires:', options: ['Placing a file at /.well-known/acme-challenge/', 'Creating a DNS TXT record', 'Responding to an email', 'All of the above'], correctAnswerIndex: 0, difficulty: 'intermediate', explanation: 'HTTP challenge: CA requests a specific file at a well-known URL. If the server responds correctly, domain control is proven.', certTags: ['Security+'] },
