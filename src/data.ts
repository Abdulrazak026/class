export const BUILD_VERSION = '2026.05.08';
...
export const curriculum: Module[] = [
    ...
    "topics": [
      {
        ...
        "quiz": [
          ...
          {
            "question": "What percentage of an analyst's time is typically spent cleaning data?",
            "options": [
              "5-10%",
              "40-60%",
              "80-90%",
      ...
      },
      {
        ...
        "type": "practice",
        "duration": "45-60 mins",
        "content": "Data is like raw ingredients in a kitchen. You can't serve raw chicken  you need to clean it, chop it, cook it, and plate it. Data follows the same path through 5 stages:\n\n1. **Collect**  Gather raw ingredients (sales records, surveys, clicks)\n2. **Clean**  Remove rotten bits (fix typos, fill blanks, remove dupes)\n3. **Analyze**  Cook and season (run calculations, find patterns)\n4. **Visualize**  Plate the dish (create charts and dashboards)\n5. **Decide**  Serve and enjoy (make a business decision)\n\nA pizza chain wanted to know which topping to feature in their next ad. They collected 50,000 orders, cleaned out 500 test records, and found pepperoni was most ordered but Hawaiian was most profitable. They featured Hawaiian and profit went up 12%.\n\n:::checkpoint\nWhat's the correct order of the Data Lifecycle?\nA) Collect, Analyze, Clean, Visualize, Decide\nB) Collect, Clean, Analyze, Visualize, Decide\nC) Clean, Collect, Analyze, Decide, Visualize\nCorrect: B\n\n:::checkpoint\nWhat does Garbage in, garbage out mean?\nA) Throw away bad data\nB) Bad input data = bad results\nC) Data analysis is a waste\nCorrect: B\n\nSkipping the Clean step is the #1 mistake beginners make. Dirty data leads to wrong conclusions  and bad business decisions.",
        "quiz": [
          {
            "question": "What is the correct order of the Data Lifecycle?",
            "options": [
              "Collect, Analyze, Clean, Visualize, Decide",
              "Collect, Clean, Analyze, Visualize, Decide",
              "Clean, Collect, Analyze, Decide, Visualize"
            ],
            "correctAnswerIndex": 1
          },
          {
          ...
          {
            "question": "What happens in the Collect stage of the data lifecycle?",
            "options": [
              "Create charts and dashboards",
              "Gather raw data like sales records and surveys",
          ...
          {
            "question": "What happens in the Clean stage of the data lifecycle?",
            "options": [
              "Delete all data",
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Your mission: build a monthly budget tracker from scratch in the spreadsheet below. It will track your money, compare budget vs actual spending, and flag when you've overspent.\n\n**Step 1: Headers**  Headers are the labels at the top of each column that tell you what's in it. Click each cell and type:\n\n- A1: `Category`\n- B1: `Budgeted`\n- C1: `Actual`\n- D1: `Difference`\n- E1: `Status`\n\n**Step 2: Categories & numbers**  In column A (rows 2-7), type your spending categories: Income, Rent, Food, Transport, Entertainment, Savings.\n\nThen fill in your budgeted amounts (column B) and what you actually spent (column C). Make up realistic numbers  Budget 1500 for Rent, 500 for Food, etc.\n\n**Step 3: Difference formula**  Click D2. Type `=C2-B2` and press Enter. This subtracts your budget from what you actually spent. If the result is positive, you spent more than budgeted (overspent). If negative, you're under budget.\n\nNow click D2 again. See the small square at the bottom-right corner? That's the **fill handle**. Drag it down to D6  it copies the formula to each row, automatically adjusting to C3-B3, C4-B4, etc. That's relative references at work.\n\n**Step 4: Status labels with IF**  The IF formula works like a traffic light: IF(this condition is true, show this, otherwise show that).\n\nClick E2 and type:\n\n`=IF(D2>0,\"Overspent\",IF(D2=0,\"On Track\",\"Under\"))`\n\nLet's break it down:\n- `D2>0`  If the difference is positive (you overspent)...\n- `\"Overspent\"`  Show this label\n- `IF(D2=0,\"On Track\",\"Under\")`  If D2 is exactly 0, show \"On Track\"; otherwise show \"Under\" (you spent less than budgeted)\n\nUse the fill handle to copy this formula down to E6.\n\n**Step 5: Totals**  Click B8 and type `=SUM(B2:B7)`. This adds up all your budgeted amounts. Do the same in C8: `=SUM(C2:C7)`.\n\n**Step 6: Formatting (concept)**  In a real spreadsheet app, you'd make the headers **bold** so they stand out, apply **currency format** ($1,200 instead of 1200) so numbers look like money, and add **borders** to separate sections. The live sheet here focuses on formulas  but these formatting skills transfer directly to Excel and Google Sheets.\n\n**Done!** Your tracker should show each category, the difference (over/under), a status label, and totals. Try changing a number in column C and watch everything update.\n\n:::checkpoint\nWhat does `=C2-B2` calculate?\nA) Total of C2 and B2\nB) Actual minus Budgeted (how much over or under)\nC) Budgeted minus Actual\nCorrect: B\n\n:::checkpoint\nIn the IF formula, what does `D2>0` mean?\nA) D2 is empty\nB) The difference is positive  overspent\nC) The difference is zero\nCorrect: B",
        "quiz": [
          {
            "question": "What formula shows the difference between Actual and Budgeted?",
            "options": [
              "=B2+C2",
              "=C2-B2",
              "=SUM(B2:C2)"
          ...
          {
            "question": "What does 'Garbage In, Garbage Out' mean in data analysis?",
            "options": [
              "Throw away old data",
              "Bad input data leads to bad results",
          ...
          {
            "question": "What is the purpose of the Clean stage in the data lifecycle?",
            "options": [
              "To delete all data",
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "In the budget project, what does =IF(D2>0,\"Overspent\",\"OK\") do?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Why should you use absolute references ($A$1) for the table array in VLOOKUP?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which conditional formatting shows a gradient from red to green?",
            "options": [
              "Data Bars",
              "Color Scales",
              "Icon Sets",
          ...
          {
            "question": "Which conditional formatting adds traffic light icons to cells?",
            "options": [
              "Data Bars",
              "Color Scales",
              "Icon Sets",
          ...
          {
            "question": "What happens when you change data that has conditional formatting rules?",
            "options": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Clean a messy real-world dataset using all the functions you've learned so far.\n\nYou receive a CSV file from a client with 1,000 customer records. It's a mess:\n- Names are in ALL CAPS\n- Phone numbers have inconsistent formats\n- Some email addresses are missing\n- There are duplicate rows\n- Extra spaces everywhere\n\nUsing the Live Sheet below, clean this data step by step:\n\n1. **Fix names:** Use =PROPER() to make 'JOHN SMITH' into 'John Smith'\n2. **Clean phones:** Use =SUBSTITUTE() to remove dashes, spaces, and parentheses\n3. **Find duplicates:** Use conditional formatting to highlight duplicate rows\n4. **Handle missing emails:** Use =IF(A2='', 'Missing', A2) to flag blanks\n5. **Trim spaces:** Use =TRIM() on every text column\n\n- All names in Proper Case\n- Phone numbers formatted consistently\n- Duplicate rows identified and marked\n- Missing emails flagged\n- Extra spaces removed\n\n:::checkpoint\nWhich function converts 'JOHN SMITH' to 'John Smith'?\nA) =UPPER()\nB) =LOWER()\nC) =PROPER()\nD) =TRIM()\nCorrect: C\n\n:::checkpoint\nWhat's the first step when cleaning a dataset?\nA) Delete everything and start over\nB) Make a backup copy of the original data\nC) Color the cells\nD) Email your boss\nCorrect: B",
        "quiz": [
          {
          ...
          {
            "question": "How should you handle missing email addresses in a customer list?",
            "options": [
    ...
    "topics": [
      {
        ...
        "quiz": [
          ...
          {
            "question": "What happens when source data changes for a pivot table?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "If you want to add 'Profit = Revenue - Cost' to a pivot table, what do you create?",
            "options": [
          ...
          {
            "question": "What is the difference between Rows and Values in a pivot table?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What type of validation would you use for an Age column (18-120)?",
            "options": [
              "Text length",
          ...
          {
            "question": "What validation type forces a cell to accept only specific values like 'Yes', 'No', 'Maybe'?",
            "options": [
              "Number range",
              "Date range",
              "Dropdown list",
          ...
          {
            "question": "You need to ensure an email column contains '@'. What validation do you use?",
            "options": [
              "Dropdown list",
              "Number range",
              "Date range",
          ...
          {
            "question": "What happens when someone enters invalid data into a validated cell?",
            "options": [
              "Excel crashes",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which chart type is best for showing the relationship between two variables (like ad spend vs sales)?",
            "options": [
              "Pie chart",
              "Bar chart",
              "Line chart",
          ...
          {
            "question": "Which chart type is best for comparing sales across multiple regions?",
            "options": [
              "Bar chart",
              "Line chart",
              "Pie chart",
          ...
          {
            "question": "Which chart type is best for showing distribution of ages in a population?",
            "options": [
              "Scatter plot",
              "Histogram",
              "Line chart",
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Build a sales summary report using pivot tables in the Live Sheet.\n\nEnter this sample data into the Live Sheet (columns A-D):\n- **A: Region** — North, South, East, West\n- **B: Month** — Jan, Feb, Mar, ... (repeat across regions)\n- **C: Product** — Widget A, Widget B, etc.\n- **D: Sales** — dollar amounts\n\nThen use the **Pivot** button (top bar) to create:\n1. **Pivot by Region** — Set Row = Region, Value = Sales, Aggregation = SUM. This gives total sales per region.\n2. **Pivot by Month** — Set Row = Month, Value = Sales, Aggregation = SUM. This shows monthly trends.\n3. **Pivot by Product** — Set Row = Product, Value = Sales, Aggregation = SUM. Sort manually to find top products.\n\nBelow the pivot grid, add formulas:\n- `=SUM(D:D)` for total sales\n- `=AVERAGE(D:D)` for average sale\n- `=COUNT(D:D)` for order count\n\n**Stretch goal:** Create a separate sheet area where you use `=SUMIF(region, \"North\", sales)` style formulas to cross-check pivot results.\n\n:::checkpoint\nWhat's the minimum you need for a useful data summary?\nA) Multiple sheets with random data\nB) Organized data plus a pivot table or formula to answer a question\nC) Lots of colors\nD) At least 10 charts\nCorrect: B",
        "quiz": [
          {
          ...
          {
            "question": "What is the purpose of conditional formatting in a dashboard?",
            "options": [
          ...
          {
            "question": "What's the best way to show total sales by region in a dashboard?",
            "options": [
    ...
    "topics": [
      {
        ...
        "description": "Sum, count, and average data that meets multiple conditions",
        "type": "learn",
        "duration": "45-60 mins",
        "content": "Basic SUM adds everything. But what if you only want to add sales for Electronics? Or count only Food products? Or average Clothing sales in the East region? That's where **SUMIF**, **COUNTIF**, **SUMIFS**, **COUNTIFS**, and **AVERAGEIFS** come in.\n\n**=SUMIF(range, criteria, sum_range)**\nSum cells that match one condition.\n\n**=COUNTIF(range, criteria)**\nCount cells that match one condition.\n\n**=SUMIFS(sum_range, criteria_range1, criteria1, criteria_range2, criteria2, ...)**\nSum cells that match ALL conditions.\n\n**=AVERAGEIFS(average_range, criteria_range1, criteria1, ...)**\nAverage cells that match ALL conditions.\n\nIn the spreadsheet below, you have a product table. Try these formulas already in the sheet:\n\nC12: =SUMIF(B2:B10,\"Electronics\",C2:C10) — total sales of all Electronics products = 2300\n\nC13: =COUNTIF(B2:B10,\"Food\") — counts how many products are Food = 3\n\nC14: =SUMIFS(C2:C10,B2:B10,\"Clothing\",E2:E10,\"East\") — adds sales where category is Clothing AND region is East = 1500\n\nC15: =AVERAGEIFS(C2:C10,B2:B10,\"Electronics\",E2:E10,\"North\") — average sales of Electronics in the North region = 733\n\n:::checkpoint\nWhat does SUMIFS do that SUMIF cannot?\nA) Nothing, they're the same\nB) SUMIFS handles multiple conditions, SUMIF handles only one\nC) SUMIFS is faster\nD) SUMIFS works with text only\nCorrect: B\n\n:::checkpoint\nHow many conditions can COUNTIFS handle?\nA) Only 1\nB) Up to 127 pairs of ranges and criteria\nC) Unlimited\nD) Only 2\nCorrect: B",
        "quiz": [
          { "question": "What does SUMIFS do that SUMIF cannot?", "options": ["Nothing", "Handle multiple conditions", "Is faster", "Works with text"], "correctAnswerIndex": 1 },
          { "question": "How many range/criteria pairs can COUNTIFS handle?", "options": ["Only 1", "Up to 127", "Unlimited", "Only 2"], "correctAnswerIndex": 1 },
          { "question": "Which function counts non-empty cells?", "options": ["COUNT", "COUNTA", "COUNTIF", "COUNTBLANK"], "correctAnswerIndex": 1 },
          { "question": "What does AVERAGEIFS return if no cells match?", "options": ["#DIV/0!", "0", "Blank", "Error"], "correctAnswerIndex": 0 },
          { "question": "In SUMIFS, which argument is the sum_range?", "options": ["The last argument", "The first argument", "The second argument", "Any argument"], "correctAnswerIndex": 1 }
        ]
      },
      {
        "id": "w_adv1-d2",
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Build a financial model that projects revenue, costs, and profit over 5 years with scenario analysis.\n\nYour task is to create a reusable financial projection model. This is a common real-world task for data analysts working in business finance.\n\nIn the spreadsheet below, you'll find:\n- Revenue and COGS for 2020-2024 (actual data)\n- Formulas already compute Gross Profit, Margin %, and YoY Growth\n\nYour mission:\n1. Project Year 2025: Add a row for 2025 and use =AVERAGE() of previous growth rates to estimate revenue\n2. Add a Scenario Analysis section showing Best Case (+10% growth), Expected Case (average growth), and Worst Case (-5% growth)\n3. Add conditional formatting to highlight best and worst years\n4. Create a summary section with totals and averages\n\n- Revenue projection formula using historical growth\n- Three scenario outcomes\n- Summary metrics (total, average, max, min)\n- Conditional formatting on projections\n\n:::checkpoint\nWhat's the best way to project future revenue?\nA) Guess randomly\nB) Use historical growth rates to estimate\nC) Pick the highest number\nD) Use the lowest number\nCorrect: B",
        "quiz": [
          { "question": "Best way to project revenue?", "options": ["Guess randomly", "Use historical growth rates", "Pick highest", "Pick lowest"], "correctAnswerIndex": 1 },
          { "question": "What does goal seek help with in financial models?", "options": ["Find input to hit target", "Create charts", "Delete data", "Format cells"], "correctAnswerIndex": 0 },
          { "question": "How many scenarios should a good model include?", "options": ["1", "At least 3 (best/expected/worst)", "10", "None"], "correctAnswerIndex": 1 },
          { "question": "What does YoY growth tell you?", "options": ["Month-over-month change", "Year-over-year percentage change", "Total revenue", "Employee count"], "correctAnswerIndex": 1 },
          { "question": "Why add conditional formatting to projections?", "options": ["Looks pretty", "Highlights best/worst cases instantly", "Speeds up calculation", "Required by Excel"], "correctAnswerIndex": 1 }
        ],
        "requirements": [
    ...
    "topics": [
      {
        ...
        "type": "learn",
        "duration": "45-60 mins",
        "content": "Power Query (also called Get & Transform) is Excel's built-in ETL tool. **ETL = Extract, Transform, Load.** It lets you import data from any source and clean it up before loading into your spreadsheet. The best part: no formulas needed. Every click records a step you can replay later.\n\nThink of Power Query as a recipe book:\n1. **Extract**  Get data from a file, database, or website\n2. **Transform**  Remove columns, split text, change data types, merge tables\n3. **Load**  Put the cleaned data into your sheet\n\n**Common Power Query transformations:**\n- Remove columns you don't need\n- Split a full name column into first and last name\n- Replace values (e.g., 'N/A' with blank)\n- Pivot and unpivot data\n- Merge queries (like VLOOKUP but visual)\n- Group and aggregate rows\n\nIn the sheet below, practice using TEXT functions to mimic what Power Query does visually:\n- Split full names into first/last\n- Extract departments from email addresses\n- Standardize date formats\n\nPower Query records every step. If you get new data next month, just refresh  all transformations replay automatically.\n\n:::checkpoint\nWhat does ETL stand for?\nA) Extract, Transform, Load\nB) Edit, Type, List\nC) Enter, Tab, Leave\nD) Error, Try, Log\nCorrect: A\n\n:::checkpoint\nWhat's the main advantage of Power Query?\nA) It's faster than formulas\nB) Transformations replay automatically on new data\nC) It creates charts\nD) It formats cells\nCorrect: B",
        "quiz": [
          { "question": "What does ETL stand for?", "options": ["Extract Transform Load", "Edit Type List", "Enter Tab Leave", "Error Try Log"], "correctAnswerIndex": 0 },
          { "question": "Main advantage of Power Query?", "options": ["Faster than formulas", "Replays on new data", "Creates charts", "Formats cells"], "correctAnswerIndex": 1 },
          { "question": "What can Power Query do?", "options": ["Import and clean data", "Only create charts", "Only sort data", "Only print"], "correctAnswerIndex": 0 },
          { "question": "What does Unpivot do in Power Query?", "options": ["Removes data", "Converts wide tables to tall tables", "Deletes columns", "Merges tables"], "correctAnswerIndex": 1 },
          { "question": "Where do you find Power Query in Excel?", "options": ["Data tab > Get & Transform Data", "Home tab", "Insert tab", "Formulas tab"], "correctAnswerIndex": 0 }
        ]
      },
      {
        "id": "w_pwr1-d2",
      ...
      },
      {
        ...
        "type": "practice",
        "duration": "45-60 mins",
        "content": "Speed matters in data analysis. Knowing keyboard shortcuts saves you hours and makes you look like a pro.\n\n**Navigation shortcuts:**\n- Ctrl + Arrow Key  Jump to edge of data region\n- Ctrl + Shift + Arrow  Select to edge of data\n- Ctrl + Space  Select entire column\n- Shift + Space  Select entire row\n- Ctrl + Home  Go to cell A1\n- Ctrl + End  Go to last used cell\n\n**Editing shortcuts:**\n- F2  Edit active cell\n- Ctrl + D  Fill down (copy from above)\n- Ctrl + R  Fill right (copy from left)\n- Ctrl + Enter  Fill multiple selected cells with same value\n- Ctrl + ;  Insert today's date\n- Ctrl + Shift + ;  Insert current time\n- Alt + =  Insert SUM formula\n- F4  Toggle absolute/relative reference\n- Ctrl + Shift + L  Toggle filter\n- Alt + F1  Create chart\n\n**Pro tip:** The Alt key reveals ribbon keyboard hints. Press Alt, then the letter for each tab.\n\n:::checkpoint\nWhich shortcut jumps to the edge of a data region?\nA) Ctrl + Home\nB) Ctrl + Arrow Key\nC) Ctrl + End\nD) Alt + F1\nCorrect: B\n\n:::checkpoint\nWhat does F4 do in a formula?\nA) Opens help\nB) Toggles between absolute and relative references\nC) Saves the file\nD) Calculates the sheet\nCorrect: B",
        "quiz": [
          { "question": "Jump to edge of data region?", "options": ["Ctrl+Home", "Ctrl+Arrow", "Ctrl+End", "Alt+F1"], "correctAnswerIndex": 1 },
          { "question": "F4 in formula does what?", "options": ["Opens help", "Toggles $ references", "Saves file", "Calculates"], "correctAnswerIndex": 1 },
          { "question": "Alt+= inserts what?", "options": ["SUM formula", "Today's date", "Chart", "Filter"], "correctAnswerIndex": 0 },
          { "question": "Ctrl+Shift+L toggles:", "options": ["Filters", "Bold", "Charts", "Pivot tables"], "correctAnswerIndex": 0 },
          { "question": "F2 edits which cell?", "options": ["The active cell", "Cell A1", "The last cell", "All cells"], "correctAnswerIndex": 0 }
        ]
      },
      {
        "id": "w_pwr1-d4",
        "title": "Day 4: Advanced Data Cleaning",
        "description": "Handle duplicates, outliers, missing values, and inconsistencies",
        "type": "learn",
        "duration": "45-60 mins",
        "content": "Real-world data is never clean. You'll encounter missing values, duplicates, outliers, formatting inconsistencies, and data type mismatches. Knowing how to handle each is critical.\n\n**Missing Values:**\n- Delete the row (if too many missing)\n- Fill with mean/median (for numeric data)\n- Fill with 'Unknown' or 'N/A' (for text)\n- Interpolate from neighboring values (for time series)\n\n**Duplicates:**\n- Use Remove Duplicates (Data tab)\n- Use conditional formatting to highlight duplicates first\n- Always verify which duplicate to keep\n\n**Outliers:**\n- Sort data and check extremes\n- Use quartiles: anything below Q1 - 1.5*IQR or above Q3 + 1.5*IQR\n- Investigate before deleting  outliers might be valuable\n\n**Inconsistencies:**\n- 'NY', 'New York', 'new york' are all the same city\n- Use TRIM, PROPER, UPPER, or LOWER to standardize\n- Create a lookup table for aliases\n\nThe spreadsheet below has real messy data: practice identifying and flagging issues.\n\n:::checkpoint\nWhat's the first step when handling missing values?\nA) Delete everything\nB) Understand WHY the data is missing\nC) Fill with zeros\nD) Ignore them\nCorrect: B\n\n:::checkpoint\nAn outlier should always be deleted. True or False?\nA) True\nB) False  outliers may contain valuable signals\nCorrect: B",
        "quiz": [
          { "question": "First step for missing values?", "options": ["Delete all", "Understand why", "Fill zeros", "Ignore"], "correctAnswerIndex": 1 },
          { "question": "Should outliers always be deleted?", "options": ["Yes", "No, they may contain signals", "Always keep", "Depends on file size"], "correctAnswerIndex": 1 },
          { "question": "Best way to find duplicates?", "options": ["Manual check", "Conditional formatting or Remove Duplicates", "Random deletion", "Sort alphabetically"], "correctAnswerIndex": 1 },
          { "question": "How to standardize 'NY' and 'New York'?", "options": ["Use VLOOKUP with alias table", "Delete both", "Use SUMIF", "Create pivot table"], "correctAnswerIndex": 0 },
          { "question": "What's the IQR method used for?", "options": ["Finding outliers", "Sorting data", "Creating charts", "Cleaning text"], "correctAnswerIndex": 0 }
        ]
      },
      {
        "id": "w_pwr1-d5",
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Build a complete data pipeline: take raw transaction data, clean it, transform it, and produce a summary report.\n\nYou receive raw transaction data (in the spreadsheet below) with the following issues:\n- Some transaction IDs are missing\n- Dates are inconsistent\n- Product names have special characters and extra spaces\n- Amount column has some text values\n- There are duplicate rows\n\n**Your task:**\n1. Identify all data quality issues and document them\n2. Clean the data using formulas (TRIM, PROPER, SUBSTITUTE, IF)\n3. Remove duplicate rows\n4. Create a summary pivot table showing total sales by category and month\n5. Add conditional formatting to highlight top-selling products\n\n- All data quality issues documented\n- Clean formulas applied correctly\n- Duplicates removed\n- Pivot table summary\n- Conditional formatting applied\n\n:::checkpoint\nWhat's the most important rule of data cleaning?\nA) Delete all nulls immediately\nB) Always keep a backup of the original data\nC) Use the most complex formula possible\nD) Clean as fast as you can\nCorrect: B",
        "quiz": [
          { "question": "Most important data cleaning rule?", "options": ["Delete nulls", "Keep original backup", "Use complex formulas", "Clean fast"], "correctAnswerIndex": 1 },
          { "question": "What tool summarizes cleaned data?", "options": ["Pivot table", "Flash Fill", "Goal Seek", "Power Query"], "correctAnswerIndex": 0 },
          { "question": "What function removes extra spaces?", "options": ["TRIM", "CLEAN", "SUBSTITUTE", "REPLACE"], "correctAnswerIndex": 0 },
          { "question": "When should you delete a row?", "options": ["When most values are missing", "When one cell is empty", "When data looks wrong", "Never"], "correctAnswerIndex": 0 },
          { "question": "What does a data pipeline do?", "options": ["Takes raw data through cleaning to analysis", "Creates charts", "Writes SQL queries", "Formats cells"], "correctAnswerIndex": 0 }
        ],
        "requirements": [
          "Issues documented",
          "Clean formulas",
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "2-3 hrs",
        "content": "Combine everything from Month 1 into a polished Excel portfolio project.\n\nYou're applying for a junior data analyst role. You need a portfolio piece that demonstrates:\n- Data cleaning skills\n- Formula knowledge (SUM, IF, VLOOKUP, text functions)\n- Pivot table ability\n- Data visualization (conditional formatting + charts)\n- Professional presentation\n\nBuild a complete Excel workbook with:\n1. **Sheet 1: Raw Data**  Import or create a dataset (500+ rows of sales, inventory, or survey data)\n2. **Sheet 2: Clean Data**  Clean version using formulas (PROPER, TRIM, SUBSTITUTE)\n3. **Sheet 3: Analysis**  Pivot tables and key metrics\n4. **Sheet 4: Dashboard**  Summary with conditional formatting\n5. **Sheet 5: Documentation**  README-style sheet explaining your process\n\n- 5 sheets in one workbook\n- At least 3 different formulas used\n- At least 1 pivot table\n- Conditional formatting on key metrics\n- Professional formatting (headers, colors, alignment)\n\n:::checkpoint\nWhy should you include a documentation sheet in your portfolio?\nA) It takes up space\nB) It shows employers you can communicate your process clearly\nC) It's required by Excel\nD) It makes the file bigger\nCorrect: B",
        "quiz": [
          {
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "How do you select only distinct (unique) department names?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What does SELECT * FROM employees ORDER BY salary DESC LIMIT 1 return?",
            "options": [
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "SELECT department, SUM(salary) GROUP BY department gives?",
            "options": [
              "Error",
          ...
          {
            "question": "If you SELECT name, department FROM employees GROUP BY department, what happens?",
            "options": [
              "It works normally",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What does SUBSTR(order_date, 6, 2) extract from '2024-02-15'?",
            "options": [
              "2024",
              "02 (the month)",
              "15 (the day)",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "If you need total revenue per customer, which clause do you need?",
            "options": [
              "ORDER BY",
              "GROUP BY",
              "WHERE",
    ...
    "topics": [
      {
        ...
        "quiz": [
          ...
          {
            "question": "In the Playground tables, which column is the primary key of employees?",
            "options": [
              "name",
              "id",
              "department",
          ...
          {
            "question": "If Engineering is renamed to Engineering Dept, with a departments table how many changes?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "In an INNER JOIN, what happens to employees whose department doesn't exist in the departments table?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "How do you find employees whose department doesn't exist in the departments table?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which join would you use to find rows in BOTH tables that have no match in the other?",
            "options": [
              "INNER JOIN",
              "LEFT JOIN",
              "FULL OUTER JOIN",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "To find departments with no employees, what pattern do you use?",
            "options": [
          ...
          {
            "question": "What type of join do you need to add a department budget column to each employee?",
            "options": [
              "No join needed",
          ...
          {
            "question": "After joining employees to departments, how do you count employees per location?",
            "options": [
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which operator would you use to combine employee names with department names into one list?",
            "options": [
              "JOIN",
              "UNION",
              "GROUP BY",
          ...
          {
            "question": "If two queries both return 'Alice' and you use UNION ALL, how many times does Alice appear?",
            "options": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "2-3 hrs",
        "content": "Your Month 2 Capstone: analyze the sample data using everything you've learned.\n\n**Deliverable:** Write SQL queries that answer these questions:\n\n1. **Total revenue (sum of all order amounts)**\n2. **Average salary by department, sorted highest to lowest**\n3. **Top 2 highest-paid employees**\n4. **Number of orders per customer, only showing customers with 2+ orders**\n5. **Each employee's name alongside their department budget** (join + join)\n6. **Salary levels using CASE: 'High' (>90000), 'Mid' (60000-90000), 'Low' (<60000)**\n7. **Count of employees per salary level**\n8. **Bonus — Pivot sales by month:** Write a query that shows total sales for each product category as separate columns. Use CASE with SUM to pivot month values into columns:\n   ```sql\n   SELECT\n     product,\n     SUM(CASE WHEN month = 'Jan' THEN amount ELSE 0 END) AS jan_sales,\n     SUM(CASE WHEN month = 'Feb' THEN amount ELSE 0 END) AS feb_sales,\n     SUM(CASE WHEN month = 'Mar' THEN amount ELSE 0 END) AS mar_sales\n   FROM sales\n   GROUP BY product;\n   ```\n   This pattern (CASE inside SUM) is how you pivot data in SQL — useful for reports that need months or categories as columns.\n\nRun each query in the Playground. Copy your queries somewhere safe  they're your first SQL portfolio piece.\n\n:::checkpoint\nFor #5 (employees with department budget), which join type?\nA) INNER JOIN  only employees whose department exists in departments table\nB) LEFT JOIN  all employees, with budget if available\nC) RIGHT JOIN  all departments\nD) Either A or B, depending on whether you want all employees or only matched ones\nCorrect: D",
        "quiz": [
          {
          ...
          {
            "question": "What skill is needed for query #4 (count per salary level)?",
            "options": [
              "CASE + GROUP BY",
              "JOIN + WHERE",
              "ORDER BY + LIMIT",
    ...
    "topics": [
      {
        ...
        "quiz": [
          ...
          {
            "question": "Why use a subquery instead of manually running two queries?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Can you reference a CTE multiple times in the same query?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What makes CTEs better than nested subqueries for complex queries?",
            "options": [
              "CTEs are faster",
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "If salaries are 100k, 90k, 90k, 80k, what does RANK give for the third employee (90k)?",
            "options": [
              "2",
              "3",
              "4",
          ...
          {
            "question": "If salaries are 100k, 90k, 90k, 80k, what does DENSE_RANK give for the third employee (90k)?",
            "options": [
              "1",
              "2",
              "3",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What does LAG(salary) OVER (ORDER BY date) do in a time series?",
            "options": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Use window functions to rank and compare data:\n\n1. **Rank employees** by salary within each department (use RANK with PARTITION BY)\n2. **Find top 2 earners** in each department (use ROW_NUMBER in a CTE)\n3. **Divide employees** into 3 salary tiers using NTILE(3)\n4. **Show each employee's salary** alongside the previous employee's salary (LAG)\n5. **Calculate the difference** between each employee's salary and their department average (use AVG OVER PARTITION BY)\n\nWrite each query and note the results.\n\n:::checkpoint\nTo find the top 2 earners per department, the best approach is:\nA) ORDER BY salary DESC LIMIT 2\nB) ROW_NUMBER() OVER (PARTITION BY department ORDER BY salary DESC) in a CTE, then filter WHERE rank <= 2\nC) GROUP BY department\nD) MAX(salary) with GROUP BY\nCorrect: B",
        "quiz": [
          {
    ...
    "topics": [
      {
        ...
        "quiz": [
          ...
          {
            "question": "What keyword inside OVER() defines the order of accumulation?",
            "options": [
              "PARTITION BY",
              "ORDER BY",
              "GROUP BY",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What does AVG(amount) OVER (ORDER BY date ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) compute?",
            "options": [
          ...
          {
            "question": "For a 5-row moving average, what frame clause do you use?",
            "options": [
          ...
          {
            "question": "What does ROWS BETWEEN UNBOUNDED PRECEDING AND CURRENT ROW do?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "If an employee is at PERCENT_RANK = 0.9, what does that mean?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Why should you filter data BEFORE applying window functions?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What is the output of SUM(amount) OVER (ORDER BY date) on row 3?",
            "options": [
          ...
          {
            "question": "Which window function gives each row a unique sequential number?",
            "options": [
              "SUM()",
              "ROW_NUMBER()",
              "AVG()",
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "2-3 hrs",
        "content": "Your Month 3 Capstone: design and build a small database from scratch.\n\n**Scenario:** A library needs a database to track books, members, and loans.\n\n**Deliverable:** Write SQL statements for:\n\n1. **Design tables**  books (id, title, author, year), members (id, name, joined_date), loans (id, book_id, member_id, loan_date, return_date)\n2. **CREATE TABLE** statements with appropriate data types and constraints\n3. **INSERT sample data**  at least 3 books, 3 members, and 5 loans\n4. **UPDATE a loan** to mark it as returned\n5. **Query with a JOIN**  show which books are currently loaned out and to whom\n6. **Add indexes** on foreign key columns (book_id, member_id) for performance\n\nTest each statement in the Playground (the SQLite-compatible syntax).\n\n:::checkpoint\nFor the library database, which columns should be indexed?\nA) title and author\nB) book_id and member_id in the loans table (foreign keys used in JOINs)\nC) id in all tables\nD) loan_date\nCorrect: B",
        "quiz": [
          {
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What strategy should you use for missing numerical data?",
            "options": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Clean a messy dataset with Pandas:\n\n1. **Create a DataFrame** with some missing values and inconsistent data\n2. **Find all missing values** using isnull().sum()\n3. **Fill missing salaries** with the average salary\n4. **Drop rows** where the name is missing\n5. **Fill missing departments** with 'Unknown'\n6. **Verify**  confirm no nulls remain with another isnull().sum()\n\nDocument each step in your Jupyter notebook with markdown comments explaining your choices.\n\n:::checkpoint\nWhat's the first step when handling missing data?\nA) Delete everything\nB) Find where the nulls are with isnull().sum()\nC) Fill everything with zeros\nD) Ignore the problem\nCorrect: B",
        "quiz": [
          {
          ...
          {
            "question": "What is the best way to fill missing values in a salary column?",
            "options": [
              "Fill with 0",
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Use groupby, merge, pivot, and lambdas to transform data:\n\n1. **Create two DataFrames**  sales and products with a common product_id\n2. **Merge them** to add product names to sales data\n3. **Group by product** and compute total sales and quantity sold\n4. **Create a pivot table** showing sales by product and month\n5. **Add a column** categorizing sales as 'Low', 'Medium', or 'High' using apply + lambda\n\nEach step should be in its own cell with a markdown explanation.\n\n## Reshaping with pd.melt()\n\nWhile pivot_table goes from long to wide, **melt** goes from wide to long. This is useful when your data has multiple columns that should be rows (like separate year columns that should be a single 'year' column).\n\n```python\n# Wide format: each year is a separate column\ndf = pd.DataFrame({\n    'product': ['A', 'B', 'C'],\n    '2023': [100, 200, 150],\n    '2024': [120, 210, 165],\n    '2025': [140, 220, 180]\n})\n\n# Melt into long format: one 'year' column, one 'sales' column\ndf_melted = df.melt(\n    id_vars=['product'],\n    value_vars=['2023', '2024', '2025'],\n    var_name='year',\n    value_name='sales'\n)\n```\n\n**Parameters:**\n- `id_vars`: columns to keep as identifiers (don't melt)\n- `value_vars`: columns to unpivot (default = all non-id columns)\n- `var_name`: name for the new 'variable' column\n- `value_name`: name for the new 'value' column\n\nMelt is essential for preparing data for visualization libraries (which expect long format) and for storing data efficiently.\n\n## Data Wrangling (Data Munging)\n\nData wrangling is the process of cleaning, transforming, and mapping raw data into a usable format. It accounts for 60-80% of a data analyst's actual work.\n\n**Typical wrangling steps:**\n1. Discovery (profile data to understand shape)\n2. Structuring (reshape via pivot, melt, join)\n3. Cleaning (fix missing values, outliers, duplicates)\n4. Enriching (add external data)\n5. Validating (check consistency)\n6. Publishing (prepare for analysis)\n\n## Web Scraping\n\nSometimes data isn't available as a CSV or via API. Web scraping extracts data from websites automatically.\n\n**Common Python tools:**\n- **BeautifulSoup**: Parse HTML and extract elements\n- **Scrapy**: Full web scraping framework for large projects\n- **Selenium**: Automate browsers for JavaScript-heavy sites\n\n**Ethical considerations:**\n- Always check robots.txt (which pages can be scraped)\n- Don't overload servers (add delays between requests)\n- Respect copyright and terms of service\n- Never scrape personal data without consent\n\n## API Data Collection\n\nAPIs (Application Programming Interfaces) let you pull data programmatically from services like Twitter, GitHub, Spotify, or company databases.\n\n**Basic API workflow:**\n```python\nimport requests\nimport json\n\nresponse = requests.get('https://api.github.com/users/octocat')\ndata = response.json()\nprint(data['name'], data['public_repos'])\n```\n\nMany APIs require authentication tokens. Always store keys in environment variables, never in code.\n\n:::checkpoint\nTo add product names to a sales DataFrame, you would use:\nA) groupby()\nB) merge()\nC) pivot_table()\nD) apply()\nCorrect: B",
        "quiz": [
          {
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "2-3 hrs",
        "content": "Your Month 4 Capstone: create a complete EDA notebook on a dataset.\n\n**Deliverable:** A Jupyter notebook with:\n\n1. **Load data**  create or load a sample dataset\n2. **Summary statistics**  df.describe() and value_counts() for categorical columns\n3. **Missing value analysis**  find and document nulls\n4. **Correlation analysis**  correlation matrix with a written observation\n5. **Outlier detection**  use IQR or z-score to find outliers\n6. **Summary**  3-5 sentences summarizing what the data tells you\n\nEach section should have markdown headers explaining what you're doing and why.\n\n:::checkpoint\nWhat is the purpose of EDA?\nA) To build a machine learning model\nB) To understand data patterns, spot issues, and generate hypotheses\nC) To clean all data\nD) To export data to CSV\nCorrect: B",
        "quiz": [
          {
    ...
    "topics": [
      {
        ...
        "quiz": [
          ...
          {
            "question": "What's the difference between a bar chart and a histogram?",
            "options": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What is the best chart type for comparing sales across products?",
            "options": [
              "Line chart",
              "Bar chart",
              "Pie chart",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What type of chart shows the relationship between two numerical variables?",
            "options": [
              "Bar chart",
              "Scatter plot",
              "Histogram",
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Build your first BI report:\n\n1. **Create sample data**  a small sales table (date, product, region, amount)\n2. **Load into Power BI/Tableau** (or use any free tool like Google Looker Studio)\n3. **Add a calculated column** for profit (amount * 0.7 as assumed margin)\n4. **Create a bar chart** showing sales by product\n5. **Create a line chart** showing sales over time\n6. **Add a slicer/filter** for region\n\nArrange into a simple one-page report. Export as PDF or image.\n\n:::checkpoint\nWhat's the minimum needed for a useful BI report?\nA) 10 charts and lots of colors\nB) Connected data, a meaningful chart, and a filter\nC) Real-time data connection\nD) A published dashboard online\nCorrect: B",
        "quiz": [
          {
          ...
          {
            "question": "What is the difference between a calculated column and a measure in BI?",
            "options": [
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Build an interactive dashboard:\n\n1. **Connect to or create data**  sales data with date, product, region, amount\n2. **Create 3 measures**  Total Sales, Average Sale, and Profit Margin\n3. **Build 3 visualizations**  sales over time (line), sales by product (bar), sales by region (map or bar)\n4. **Add slicers**  date range and product category\n5. **Apply design best practices**  consistent colors, clear labels, remove clutter\n6. **Test cross-filtering**  clicking one chart updates the others\n\nPublish or export your dashboard.\n\n:::checkpoint\nWhat should you test before sharing a dashboard?\nA) Cross-filtering  do interactions work correctly?\nB) That all colors are different\nC) That it has at least 10 charts\nD) That no filters are available\nCorrect: A",
        "quiz": [
          {
    ...
    "topics": [
      {
        ...
        "quiz": [
          ...
          {
            "question": "What should an executive get first in a data presentation?",
            "options": [
              "Raw data tables",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which position on a slide gets the most visual attention?",
            "options": [
              "Bottom-right",
              "Top-left",
              "Center",
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "type": "project",
        "duration": "1-2 hrs",
        "content": "Analyze an A/B test using Python:\n\n1. **Create sample data**  control group with 5% conversion (50/1000) and variant with 7% conversion (70/1000)\n2. **Calculate conversion rates** for each group\n3. **Visualize**  bar chart comparing conversion rates\n4. **Run a statistical test**  use scipy.stats to calculate a p-value\n5. **Interpret the result**  is the difference significant? What would you recommend?\n\nDocument your assumptions and reasoning in the notebook.\n\n:::checkpoint\nWhat's the minimum you need to analyze an A/B test?\nA) Only the control group's data\nB) Conversion data for both groups and a statistical test\nC) Just the conversion rates with no test\nD) At least 1 million users\nCorrect: B",
        "quiz": [
          {
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What should you add to a README to make it more engaging?",
            "options": [
              "Animation",
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which metric is easiest to interpret for non-technical stakeholders?",
            "options": [
              "MSE",
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What is the default decision threshold for logistic regression?",
            "options": [
              "0.25",
              "0.5",
              "0.75",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which algorithm uses the kernel trick for nonlinear boundaries?",
            "options": [
              "KNN",
              "Naive Bayes",
              "SVM",
  ...
  {
    "id": "week28",
    "title": "Week 28: Regularization, Clustering & Feature Engineering (Month 7)",
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "What is the risk of creating too many interaction features?",
            "options": [
              "Underfitting",
  ...
  },
  {
    ...
    "topics": [
      ...
      },
      {
        ...
        "description": "Understand database types, star/snowflake schemas, and data ethics",
        "type": "learn",
        "duration": "45-60 mins",
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Which type of analytics processes data in RAM for speed?",
            "options": [
              "Cloud analytics",
              "In-memory analytics",
              "Batch analytics",
    ...
    "topics": [
      ...
      },
      {
        ...
        "quiz": [
          ...
          {
            "question": "Why calculate required sample size before running an A/B test?",
            "options": [
